...
```bash
python scripts/test.py         # freeze, house style, both pairs linted, 437 direct tests
...
The 437 direct tests cover both pairs of contracts through the double, the buyer agent,
