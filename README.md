...
```bash
python scripts/test.py         # freeze, house style, both pairs linted, 440 direct tests
...
The 440 direct tests cover both pairs of contracts through the double, the buyer agent,
