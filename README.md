...
```bash
python scripts/test.py         # freeze, house style, both pairs linted, 436 direct tests
...
The 436 direct tests cover both pairs of contracts through the double, the buyer agent,
