...
```bash
python scripts/test.py         # freeze, house style, both pairs linted, 434 direct tests
...
The 434 direct tests cover both pairs of contracts through the double, the buyer agent,
