...
import { networkQuery, settlementMoves, type NetworkName } from "@/lib/networks";
...
export default function Hero({
  ...
  dispute: string;
  explorer: string;
  /** The network the page is reading, and every deployment it could read instead. */
  network: NetworkName;
